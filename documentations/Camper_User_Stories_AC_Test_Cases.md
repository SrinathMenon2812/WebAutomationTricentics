# Camper LOB User Stories, Acceptance Criteria, and Test Cases

Version: 1.0
Date: 2026-07-30
Application: Tricentis Vehicle Insurance Sample App - Camper
Reference Spec: Camper_LOB_Functional_Business_Spec.md

## 1. Story Map Summary
- US-001: Start Camper quote from landing page
...
## US-001: Start Camper Quote
User Story:
As a prospective customer,
I want to start a Camper insurance quote from the home page,
so that I can begin the quote process quickly.

Acceptance Criteria:
1. Given the user is on the landing page, when the Camper offer is clicked, then the Camper wizard opens.
...
TC-US001-01
Type: Positive
Title: Open Camper wizard from offer tile
Preconditions:
- User is on the landing page.
Execution Steps:
1. Open https://sampleapp.tricentis.com/101/.
2. Locate the Camper offer card.
3. Click the Camper offer card.
Expected Result:
- User is navigated to the Camper quote wizard.
- Enter Vehicle Data is the active step.
- The wizard is loaded in Camper context.

TC-US001-02
Type: Positive
Title: Verify initial counters are displayed
Preconditions:
- User has opened the Camper wizard.
Execution Steps:
1. Observe the step navigation counters.
2. Record the visible counts for each step.
Expected Result:
- Enter Vehicle Data shows 9.
...
TC-US001-03
Type: Positive
Title: Start journey from the home menu Camper link
Preconditions:
- User is on the landing page.
Execution Steps:
1. Click the menu icon.
2. Click Camper from the menu.
Expected Result:
- The Camper wizard opens.
- Enter Vehicle Data is active.

TC-US001-04
Type: Negative
Title: Clicking a non-Camper card should not start the Camper flow
Preconditions:
- User is on the landing page.
Execution Steps:
1. Click the Automobile or Truck offer card.
Expected Result:
- The non-Camper line of business opens instead.
- The Camper wizard is not activated.

TC-US001-05
Type: Positive
Title: Home breadcrumb returns user to landing page
Preconditions:
- User is on the Camper wizard page.
Execution Steps:
1. Click the Home breadcrumb.
Expected Result:
- User returns to the landing page.
- The Camper offer card is visible.
...
3. Given the Right Hand Drive option is available, when the user reviews the vehicle form, then the Yes/No choice is presented.

Test Cases (5):

TC-US002-01
Type: Positive
Title: Complete Vehicle Data with valid camper values
Preconditions:
- Vehicle Data step is active.
Execution Steps:
1. Set Make to Ford.
2. Enter Engine Performance as 140.
3. Enter Date of Manufacture as 06/15/2022.
4. Set Number of Seats to 4.
5. Select Right Hand Drive as No.
6. Set Fuel Type to Diesel.
7. Enter Payload as 800.
8. Enter Total Weight as 3500.
9. Enter List Price as 42000.
10. Enter License Plate Number as CA1234.
11. Enter Annual Mileage as 12000.
12. Click Next.
Expected Result:
...
- Vehicle Data step is active.
Execution Steps:
1. Open the Make dropdown.
2. Review the available values.
Expected Result:
- The dropdown contains the expected camper make list, including Ford, Honda, Mazda, Mercedes Benz, Toyota, Volkswagen, and Volvo.

TC-US002-03
Type: Positive
Title: Right Hand Drive options are presented and selectable
Preconditions:
- Vehicle Data step is active.
Execution Steps:
1. Locate the Right Hand Drive field.
2. Select Yes.
3. Select No.
Expected Result:
- Both option choices are visible.
- Selection changes are applied without blocking the form.
...
Execution Steps:
1. Enter First Name as Emma.
2. Enter Last Name as Clark.
3. Enter Date of Birth as 01/15/1990.
4. Select Gender as Female.
5. Enter Street Address as 87 River Road.
...
3. Enter Username as camperuser.
